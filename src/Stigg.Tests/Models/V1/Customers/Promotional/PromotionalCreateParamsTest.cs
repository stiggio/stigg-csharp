...
public class PromotionalCreateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new PromotionalCreateParams
        {
    ...
    {
        PromotionalCreateParams parameters = new()
        {
            CustomerID = "customerId",
            PromotionalEntitlements =
            [
    ...
    public void CopyConstructor_Works()
    {
        ...
        PromotionalCreateParams copied = new(parameters);
