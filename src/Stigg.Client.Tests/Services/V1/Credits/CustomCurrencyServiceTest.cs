...
public class CustomCurrencyServiceTest : TestBase
{
    ...
    {
        var customCurrency = await this.client.V1.Credits.CustomCurrencies.Create(
    ...
    {
        var customCurrency = await this.client.V1.Credits.CustomCurrencies.Update(
            "currencyId",
            new(),
            TestContext.Current.CancellationToken
        );
    ...
    {
        var customCurrency = await this.client.V1.Credits.CustomCurrencies.Archive(
            "currencyId",
            new(),
            TestContext.Current.CancellationToken
        );
    ...
    {
        var customCurrency = await this.client.V1.Credits.CustomCurrencies.Unarchive(
            "currencyId",
            new(),
            TestContext.Current.CancellationToken
        );
