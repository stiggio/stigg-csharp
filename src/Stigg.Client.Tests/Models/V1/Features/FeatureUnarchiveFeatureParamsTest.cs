...
public class FeatureUnarchiveFeatureParamsTest : TestBase
{
    ...
    {
        var parameters = new FeatureUnarchiveFeatureParams
        {
            ID = "x",
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(new Uri("https://api.stigg.io/api/v1/features/x/unarchive"), url)
        );
    }
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        FeatureUnarchiveFeatureParams parameters = new()
        {
            ID = "x",
            XAccountID = "X-ACCOUNT-ID",
            XEnvironmentID = "X-ENVIRONMENT-ID",
