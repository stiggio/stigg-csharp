...
public class FeatureRetrieveFeatureParamsTest : TestBase
{
    ...
    {
        var parameters = new FeatureRetrieveFeatureParams
        {
            ID = "x",
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(new Uri("https://edge.api.stigg.io/api/v1/features/x"), url)
        );
    }
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        FeatureRetrieveFeatureParams parameters = new()
        {
            ID = "x",
            XAccountID = "X-ACCOUNT-ID",
            XEnvironmentID = "X-ENVIRONMENT-ID",
