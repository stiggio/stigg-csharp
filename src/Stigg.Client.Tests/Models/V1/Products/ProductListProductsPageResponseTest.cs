...
public class ProductListProductsPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProductListProductsPageResponse
        {
            Data =
            [
                new()
        ...
        List<ProductListProductsResponse> expectedData =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ProductListProductsPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProductListProductsPageResponse copied = new(model);
