...
public class ProductArchiveProductParamsTest : TestBase
{
    ...
    {
        var parameters = new ProductArchiveProductParams
        {
            ID = "x",
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(new Uri("https://edge.api.stigg.io/api/v1/products/x/archive"), url)
        );
    }
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        ProductArchiveProductParams parameters = new()
        {
            ID = "x",
            XAccountID = "X-ACCOUNT-ID",
            XEnvironmentID = "X-ENVIRONMENT-ID",
