    ...
    public void FieldRoundtrip_Works()
    {
        var model = new ContractDeleteResponse
        {
            Data = new()
            {
                ...
                BillingID = "billingId",
                BillingState = ContractDeleteResponseDataBillingState.Draft,
...
public class ContractDeleteResponseDataTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, ContractDeleteResponseDataBillingState> expectedBillingState =
            ContractDeleteResponseDataBillingState.Draft;
...
public class ContractDeleteResponseDataBillingStateTest : TestBase
{
    [Theory]
    [InlineData(ContractDeleteResponseDataBillingState.Draft)]
    [InlineData(ContractDeleteResponseDataBillingState.Active)]
    [InlineData(ContractDeleteResponseDataBillingState.Canceled)]
    [InlineData(ContractDeleteResponseDataBillingState.EndBilling)]
    public void Validation_Works(ContractDeleteResponseDataBillingState rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ContractDeleteResponseDataBillingState> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ContractDeleteResponseDataBillingState.Canceled)]
    [InlineData(ContractDeleteResponseDataBillingState.EndBilling)]
    public void SerializationRoundtrip_Works(ContractDeleteResponseDataBillingState rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ContractDeleteResponseDataBillingState> value = rawValue;
