...
public class ContractCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ContractCreateResponse
        {
            Data = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ContractCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ContractCreateResponse copied = new(model);
...
public class DataTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<DataSubscription> expectedSubscriptions =
        [
            new()
            {
                PlanDisplayName = "planDisplayName",
...
public class DataSubscriptionTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new DataSubscription
        {
            PlanDisplayName = "planDisplayName",
            ProductDisplayName = "productDisplayName",
            SubscriptionID = "subscriptionId",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<DataSubscription>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        DataSubscription copied = new(model);
