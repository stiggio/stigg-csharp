...
public class PromotionalEntitlementListPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PromotionalEntitlementListPageResponse
        {
            Data =
            [
                new()
        ...
        List<PromotionalEntitlementListResponse> expectedData =
        [
            new()
            {
                ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<PromotionalEntitlementListPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        PromotionalEntitlementListPageResponse copied = new(model);
