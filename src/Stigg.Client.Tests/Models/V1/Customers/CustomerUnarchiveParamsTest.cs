...
public class CustomerUnarchiveParamsTest : TestBase
{
    ...
    {
        var parameters = new CustomerUnarchiveParams
        {
            ID = "x",
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(new Uri("https://api.stigg.io/api/v1/customers/x/unarchive"), url)
        );
    }
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        CustomerUnarchiveParams parameters = new()
        {
            ID = "x",
            XAccountID = "X-ACCOUNT-ID",
            XEnvironmentID = "X-ENVIRONMENT-ID",
