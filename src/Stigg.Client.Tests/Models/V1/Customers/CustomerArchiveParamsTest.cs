...
public class CustomerArchiveParamsTest : TestBase
{
    ...
    {
        var parameters = new CustomerArchiveParams
        {
            ID = "x",
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(new Uri("https://edge.api.stigg.io/api/v1/customers/x/archive"), url)
        );
    }
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        CustomerArchiveParams parameters = new()
        {
            ID = "x",
            XAccountID = "X-ACCOUNT-ID",
            XEnvironmentID = "X-ENVIRONMENT-ID",
