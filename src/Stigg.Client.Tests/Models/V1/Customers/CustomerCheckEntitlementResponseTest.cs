...
public class CustomerCheckEntitlementResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CustomerCheckEntitlementResponse
        {
            Data = new Feature()
            {
        ...
        CustomerCheckEntitlementResponseData expectedData = new Feature()
        {
            AccessDeniedReason = AccessDeniedReason.FeatureNotFound,
            IsGranted = true,
            CurrentUsage = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CustomerCheckEntitlementResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        CustomerCheckEntitlementResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class CustomerCheckEntitlementResponseDataTest : TestBase
{
    [Fact]
    public void FeatureValidationWorks()
    {
        CustomerCheckEntitlementResponseData value = new Feature()
        {
            AccessDeniedReason = AccessDeniedReason.FeatureNotFound,
            IsGranted = true,
            CurrentUsage = 0,
    ...
    {
        CustomerCheckEntitlementResponseData value = new Credit()
        {
    ...
    public void FeatureSerializationRoundtripWorks()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CustomerCheckEntitlementResponseData>(
            element,
            ModelBase.SerializerOptions
        );
