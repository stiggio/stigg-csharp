...
public class CustomerListResourcesParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new CustomerListResourcesParams
        {
            ID = "x",
    ...
    {
        var parameters = new CustomerListResourcesParams { ID = "x" };
    ...
    {
        CustomerListResourcesParams parameters = new()
        {
            ID = "x",
            After = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            Before = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://edge.api.stigg.io/api/v1/customers/x/resources?after=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&before=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&limit=1"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CustomerListResourcesParams copied = new(parameters);
