...
public class AddonCreateDraftParamsTest : TestBase
{
    ...
    {
        var parameters = new AddonCreateDraftParams
        {
            ID = "x",
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(new Uri("https://edge.api.stigg.io/api/v1/addons/x/draft"), url)
        );
    }
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        AddonCreateDraftParams parameters = new()
        {
            ID = "x",
            XAccountID = "X-ACCOUNT-ID",
            XEnvironmentID = "X-ENVIRONMENT-ID",
