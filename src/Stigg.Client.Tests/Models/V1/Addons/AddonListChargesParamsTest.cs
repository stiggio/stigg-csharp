...
public class AddonListChargesParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new AddonListChargesParams
        {
            ID = "x",
    ...
    {
        var parameters = new AddonListChargesParams { ID = "x" };
    ...
    {
        AddonListChargesParams parameters = new()
        {
            ID = "x",
            After = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            Before = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://edge.api.stigg.io/api/v1/addons/x/charges?after=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&before=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&limit=1"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        AddonListChargesParams copied = new(parameters);
