...
public class ConsumptionConsumeAsyncResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ConsumptionConsumeAsyncResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ConsumptionConsumeAsyncResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ConsumptionConsumeAsyncResponse copied = new(model);
