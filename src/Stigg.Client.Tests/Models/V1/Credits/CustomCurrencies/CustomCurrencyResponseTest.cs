...
public class CustomCurrencyResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CustomCurrencyResponse
        {
            Data = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CustomCurrencyResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        CustomCurrencyResponse copied = new(model);
