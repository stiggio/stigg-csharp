...
public class CustomCurrencyListPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CustomCurrencyListPageResponse
        {
            Data =
            [
                new()
        ...
        List<CustomCurrencyListResponse> expectedData =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CustomCurrencyListPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        CustomCurrencyListPageResponse copied = new(model);
