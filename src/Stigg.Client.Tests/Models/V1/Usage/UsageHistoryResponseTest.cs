...
public class UsageHistoryResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Usage::UsageHistoryResponse
        {
            Data = new()
            {
                Markers =
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Usage::UsageHistoryResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Usage::UsageHistoryResponse copied = new(model);
