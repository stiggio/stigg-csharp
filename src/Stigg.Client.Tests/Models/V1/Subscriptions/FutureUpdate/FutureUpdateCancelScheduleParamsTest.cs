...
public class FutureUpdateCancelScheduleParamsTest : TestBase
{
    ...
    {
        var parameters = new FutureUpdateCancelScheduleParams
        {
            ID = "x",
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri("https://edge.api.stigg.io/api/v1/subscriptions/x/future-update/schedule"),
                url
            )
        );
    }
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        FutureUpdateCancelScheduleParams parameters = new()
        {
            ID = "x",
            XAccountID = "X-ACCOUNT-ID",
            XEnvironmentID = "X-ENVIRONMENT-ID",
