...
public class SubscriptionMigrateResponseDataTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        > expectedPaymentCollectionMethod =
            SubscriptionMigrateResponseDataPaymentCollectionMethod.Charge;
        List<SubscriptionMigrateResponseDataPrice> expectedPrices =
        [
            new()
            {
                ID = "id",
...
public class SubscriptionMigrateResponseDataPriceTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionMigrateResponseDataPrice
        {
            ID = "id",
            CreatedAt = "createdAt",
            UpdatedAt = "updatedAt",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<SubscriptionMigrateResponseDataPrice>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionMigrateResponseDataPrice copied = new(model);
