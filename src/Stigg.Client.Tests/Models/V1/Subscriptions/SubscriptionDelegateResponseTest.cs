...
public class SubscriptionDelegateResponseDataTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        > expectedPaymentCollectionMethod =
            SubscriptionDelegateResponseDataPaymentCollectionMethod.Charge;
        List<SubscriptionDelegateResponseDataPrice> expectedPrices =
        [
            new()
            {
                ID = "id",
...
public class SubscriptionDelegateResponseDataPriceTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubscriptionDelegateResponseDataPrice
        {
            ID = "id",
            CreatedAt = "createdAt",
            UpdatedAt = "updatedAt",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<SubscriptionDelegateResponseDataPrice>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubscriptionDelegateResponseDataPrice copied = new(model);
