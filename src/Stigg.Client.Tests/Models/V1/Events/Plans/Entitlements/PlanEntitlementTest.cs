...
using Entitlements = Stigg.Client.Models.V1.Events.Plans.Entitlements;

namespace Stigg.Client.Tests.Models.V1.Events.Plans.Entitlements;

public class PlanEntitlementTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Entitlements::PlanEntitlement
        {
            Data = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Entitlements::PlanEntitlement>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Entitlements::PlanEntitlement copied = new(model);
