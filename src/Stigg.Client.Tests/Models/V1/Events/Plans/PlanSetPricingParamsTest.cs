...
public class PlanSetPricingParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new PlanSetPricingParams
        {
            ID = "x",
            PricingType = PlanSetPricingParamsPricingType.Free,
            BillingID = "billingId",
            MinimumSpend =
            [
                new()
        ...
        string expectedID = "x";
        ApiEnum<string, PlanSetPricingParamsPricingType> expectedPricingType =
            PlanSetPricingParamsPricingType.Free;
    ...
    {
        PlanSetPricingParams parameters = new()
        {
            ID = "x",
            PricingType = PlanSetPricingParamsPricingType.Free,
        };
        ...
        Assert.Equal(new Uri("https://api.stigg.io/api/v1/plans/x/charges"), url);
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        PlanSetPricingParams copied = new(parameters);

        Assert.Equal(parameters, copied);
    }
}

public class PlanSetPricingParamsPricingTypeTest : TestBase
{
    [Theory]
    [InlineData(PlanSetPricingParamsPricingType.Free)]
    [InlineData(PlanSetPricingParamsPricingType.Paid)]
    [InlineData(PlanSetPricingParamsPricingType.Custom)]
    public void Validation_Works(PlanSetPricingParamsPricingType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PlanSetPricingParamsPricingType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, PlanSetPricingParamsPricingType>>(
    ...
    [InlineData(PlanSetPricingParamsPricingType.Paid)]
    [InlineData(PlanSetPricingParamsPricingType.Custom)]
    public void SerializationRoundtrip_Works(PlanSetPricingParamsPricingType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, PlanSetPricingParamsPricingType> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, PlanSetPricingParamsPricingType>
