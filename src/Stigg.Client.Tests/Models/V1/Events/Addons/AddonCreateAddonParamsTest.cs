...
public class AddonCreateAddonParamsTest : TestBase
{
    [Fact]
    ...
    {
        AddonCreateAddonParams parameters = new()
        {
            ID = "id",
            DisplayName = "displayName",
            ProductID = "productId",
        ...
        Assert.Equal(new Uri("https://api.stigg.io/api/v1/addons"), url);
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        AddonCreateAddonParams copied = new(parameters);
