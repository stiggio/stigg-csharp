...
public class AddonListAddonsPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AddonListAddonsPageResponse
        {
            Data =
            [
                new()
        ...
        List<AddonListAddonsResponse> expectedData =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AddonListAddonsPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AddonListAddonsPageResponse copied = new(model);
