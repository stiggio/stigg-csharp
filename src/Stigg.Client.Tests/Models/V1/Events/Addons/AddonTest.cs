...
public class AddonTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Addons::Addon>(
            json,
...
public class DataTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<Addons::DataEntitlement> expectedEntitlements =
        [
...
public class DataEntitlementTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Addons::DataEntitlement { ID = "id", Type = Addons::Type.Feature };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Addons::DataEntitlement>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Addons::DataEntitlement copied = new(model);
