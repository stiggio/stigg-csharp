...
public class CreditGetAutoRechargeResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CreditGetAutoRechargeResponse
        {
            Data = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CreditGetAutoRechargeResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        CreditGetAutoRechargeResponse copied = new(model);
