...
public class CustomCurrencyCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CustomCurrencyCreateResponse
        {
            Data = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CustomCurrencyCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        CustomCurrencyCreateResponse copied = new(model);
