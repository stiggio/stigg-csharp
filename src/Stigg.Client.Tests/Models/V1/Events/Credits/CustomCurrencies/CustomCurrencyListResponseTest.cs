...
public class CustomCurrencyListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CustomCurrencyListResponse
        {
            ID = "id",
        ...
        CustomCurrencyListResponseUnits expectedUnits = new()
        {
            Plural = "plural",
            Singular = "singular",
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CustomCurrencyListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        CustomCurrencyListResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class CustomCurrencyListResponseUnitsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CustomCurrencyListResponseUnits
        {
            Plural = "plural",
            Singular = "singular",
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CustomCurrencyListResponseUnits>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CustomCurrencyListResponseUnits copied = new(model);
