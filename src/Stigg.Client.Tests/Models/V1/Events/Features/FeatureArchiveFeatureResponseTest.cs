...
public class FeatureArchiveFeatureResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FeatureArchiveFeatureResponse
        {
            Data = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<FeatureArchiveFeatureResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        FeatureArchiveFeatureResponse copied = new(model);
