...
public class CouponArchiveCouponParamsTest : TestBase
{
    ...
    {
        var parameters = new CouponArchiveCouponParams
        {
            ID = "x",
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(new Uri("https://edge.api.stigg.io/api/v1/coupons/x/archive"), url)
        );
    }
    ...
    public void AddHeadersToRequest_Works()
    {
        ...
        CouponArchiveCouponParams parameters = new()
        {
            ID = "x",
            XAccountID = "X-ACCOUNT-ID",
            XEnvironmentID = "X-ENVIRONMENT-ID",
