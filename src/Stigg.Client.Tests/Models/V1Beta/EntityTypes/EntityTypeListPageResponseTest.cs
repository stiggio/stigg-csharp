...
public class EntityTypeListPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntityTypeListPageResponse
        {
            Data =
            [
                new()
        ...
        List<EntityTypeListResponse> expectedData =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<EntityTypeListPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntityTypeListPageResponse copied = new(model);
