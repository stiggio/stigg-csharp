...
public class EntityListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntityListResponse
        {
            ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<EntityListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntityListResponse copied = new(model);
