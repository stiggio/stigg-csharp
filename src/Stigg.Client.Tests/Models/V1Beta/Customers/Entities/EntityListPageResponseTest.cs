...
public class EntityListPageResponseTest : TestBase
{
    ...
    {
        var model = new EntityListPageResponse
        {
            Data =
            [
                new()
        ...
        List<EntityListResponse> expectedData =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<EntityListPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntityListPageResponse copied = new(model);
