...
public class EntityListParamsTest : TestBase
{
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.stigg.io/api/v1-beta/customers/id/entities?after=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&before=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&entityTypeId=entityTypeId&includeArchived=true&limit=1"
                ),
                url
            )
        );
