...
public class EventTypeTest : TestBase
{
    ...
    [InlineData(EventType.IncomingAirbyteWebhook)]
    ...
    [InlineData(EventType.DataExportSyncFailed)]
    ...
    [InlineData(EventType.EdgeApiCustomCurrencyCacheDataResync)]
    ...
    [InlineData(EventType.CustomCurrencyCreated)]
    [InlineData(EventType.CustomCurrencyUpdated)]
    [InlineData(EventType.CustomCurrencyArchived)]
    [InlineData(EventType.CustomCurrencyUnarchived)]
