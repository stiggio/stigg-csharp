...
public class EventQueueProvisionParamsTest : TestBase
{
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri("https://api.stigg.io/internal/beta/event-queues/provision"),
                url
            )
        );
    }
...
public class EventQueueProvisionParamsEventTypeTest : TestBase
{
    ...
    [InlineData(EventQueueProvisionParamsEventType.IncomingAirbyteWebhook)]
    ...
    [InlineData(EventQueueProvisionParamsEventType.DataExportSyncFailed)]
