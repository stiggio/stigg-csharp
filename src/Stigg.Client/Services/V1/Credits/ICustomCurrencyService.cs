...
public interface ICustomCurrencyService
{
    ...
    /// </summary>
    Task<CustomCurrencyResponse> Create(
    ...
    /// </summary>
    Task<CustomCurrencyResponse> Update(
    ...
    /// dependencies.
    /// </summary>
    Task<CustomCurrencyResponse> Archive(
    ...
    /// </summary>
    Task<CustomCurrencyResponse> Unarchive(
...
public interface ICustomCurrencyServiceWithRawResponse
{
    ...
    /// </summary>
    Task<HttpResponse<CustomCurrencyResponse>> Create(
        CustomCurrencyCreateParams parameters,
        CancellationToken cancellationToken = default
    );
    ...
    /// </summary>
    Task<HttpResponse<CustomCurrencyResponse>> Update(
        CustomCurrencyUpdateParams parameters,
        CancellationToken cancellationToken = default
    );
    ...
    /// </summary>
    Task<HttpResponse<CustomCurrencyResponse>> Archive(
        CustomCurrencyArchiveParams parameters,
        CancellationToken cancellationToken = default
    );
    ...
    /// </summary>
    Task<HttpResponse<CustomCurrencyResponse>> Unarchive(
        CustomCurrencyUnarchiveParams parameters,
        CancellationToken cancellationToken = default
    );
