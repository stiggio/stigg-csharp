...
public sealed class CustomCurrencyService : ICustomCurrencyService
{
    ...
    /// <inheritdoc/>
    public async Task<CustomCurrencyResponse> Create(
    ...
    /// <inheritdoc/>
    public async Task<CustomCurrencyResponse> Update(
    ...
    /// <inheritdoc/>
    public Task<CustomCurrencyResponse> Update(
        string currencyID,
    ...
    /// <inheritdoc/>
    public async Task<CustomCurrencyResponse> Archive(
    ...
    /// <inheritdoc/>
    public Task<CustomCurrencyResponse> Archive(
        string currencyID,
    ...
    /// <inheritdoc/>
    public async Task<CustomCurrencyResponse> Unarchive(
    ...
    /// <inheritdoc/>
    public Task<CustomCurrencyResponse> Unarchive(
        string currencyID,
...
public sealed class CustomCurrencyServiceWithRawResponse : ICustomCurrencyServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<CustomCurrencyResponse>> Create(
        CustomCurrencyCreateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            async (token) =>
            {
                var customCurrencyResponse = await response
                    .Deserialize<CustomCurrencyResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
                    customCurrencyResponse.Validate();
                }
                return customCurrencyResponse;
            }
        );
    }

    /// <inheritdoc/>
    public async Task<HttpResponse<CustomCurrencyResponse>> Update(
        CustomCurrencyUpdateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<CustomCurrencyResponse>> Update(
        string currencyID,
        CustomCurrencyUpdateParams? parameters = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<CustomCurrencyResponse>> Archive(
        CustomCurrencyArchiveParams parameters,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<CustomCurrencyResponse>> Archive(
        string currencyID,
        CustomCurrencyArchiveParams? parameters = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<CustomCurrencyResponse>> Unarchive(
        CustomCurrencyUnarchiveParams parameters,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<CustomCurrencyResponse>> Unarchive(
        string currencyID,
        CustomCurrencyUnarchiveParams? parameters = null,
        CancellationToken cancellationToken = default
    )
