...
public sealed class CustomCurrencyService : ICustomCurrencyService
{
    ...
    /// <inheritdoc/>
    public async Task<CustomCurrencyCreateResponse> Create(
    ...
    /// <inheritdoc/>
    public async Task<CustomCurrencyUpdateResponse> Update(
    ...
    /// <inheritdoc/>
    public Task<CustomCurrencyUpdateResponse> Update(
        string currencyID,
    ...
    /// <inheritdoc/>
    public async Task<CustomCurrencyArchiveResponse> Archive(
    ...
    /// <inheritdoc/>
    public Task<CustomCurrencyArchiveResponse> Archive(
        string currencyID,
    ...
    /// <inheritdoc/>
    public async Task<CustomCurrencyUnarchiveResponse> Unarchive(
    ...
    /// <inheritdoc/>
    public Task<CustomCurrencyUnarchiveResponse> Unarchive(
        string currencyID,
...
public sealed class CustomCurrencyServiceWithRawResponse : ICustomCurrencyServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<CustomCurrencyCreateResponse>> Create(
        CustomCurrencyCreateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            async (token) =>
            {
                var customCurrency = await response
                    .Deserialize<CustomCurrencyCreateResponse>(token)
                    .ConfigureAwait(false);
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<CustomCurrencyUpdateResponse>> Update(
        CustomCurrencyUpdateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            {
                var customCurrency = await response
                    .Deserialize<CustomCurrencyUpdateResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
                    customCurrency.Validate();
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<CustomCurrencyUpdateResponse>> Update(
        string currencyID,
        CustomCurrencyUpdateParams? parameters = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<CustomCurrencyArchiveResponse>> Archive(
        CustomCurrencyArchiveParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            async (token) =>
            {
                var deserializedResponse = await response
                    .Deserialize<CustomCurrencyArchiveResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<CustomCurrencyArchiveResponse>> Archive(
        string currencyID,
        CustomCurrencyArchiveParams? parameters = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// <inheritdoc/>
    public async Task<HttpResponse<CustomCurrencyUnarchiveResponse>> Unarchive(
        CustomCurrencyUnarchiveParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            {
                var deserializedResponse = await response
                    .Deserialize<CustomCurrencyUnarchiveResponse>(token)
                    .ConfigureAwait(false);
                if (this._client.ResponseValidation)
                {
                    deserializedResponse.Validate();
    ...
    /// <inheritdoc/>
    public Task<HttpResponse<CustomCurrencyUnarchiveResponse>> Unarchive(
        string currencyID,
        CustomCurrencyUnarchiveParams? parameters = null,
        CancellationToken cancellationToken = default
    )
