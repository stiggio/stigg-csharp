...
namespace Stigg.Client.Services.V1.Addons;
...
public interface IEntitlementServiceWithRawResponse
{
    ...
    /// <summary>
    /// Returns a raw HTTP response for <c>post /api/v1/addons/{addonId}/entitlements</c>, but is otherwise the
    ...
    /// <summary>
    /// Returns a raw HTTP response for <c>patch /api/v1/addons/{addonId}/entitlements/{id}</c>, but is otherwise the
    ...
    /// <summary>
    /// Returns a raw HTTP response for <c>get /api/v1/addons/{addonId}/entitlements</c>, but is otherwise the
    ...
    /// <summary>
    /// Returns a raw HTTP response for <c>delete /api/v1/addons/{addonId}/entitlements/{id}</c>, but is otherwise the
