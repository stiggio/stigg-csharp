...
public sealed class CreditService : ICreditService
{
    ...
    public CreditService(IStiggClient client)
    {
        ...
        _autoRecharge = new(() => new AutoRechargeService(client));
    }
    ...
    readonly Lazy<IAutoRechargeService> _autoRecharge;
    public IAutoRechargeService AutoRecharge
    {
        get { return _autoRecharge.Value; }
    }
...
public sealed class CreditServiceWithRawResponse : ICreditServiceWithRawResponse
{
    ...
    public CreditServiceWithRawResponse(IStiggClientWithRawResponse client)
    {
        ...
        _autoRecharge = new(() => new AutoRechargeServiceWithRawResponse(client));
    }
    ...
    readonly Lazy<IAutoRechargeServiceWithRawResponse> _autoRecharge;
    public IAutoRechargeServiceWithRawResponse AutoRecharge
    {
        get { return _autoRecharge.Value; }
    }
