...
public record struct ClientOptions()
{
    ...
    Lazy<string> _baseUrl = new(() =>
        Environment.GetEnvironmentVariable("STIGG_BASE_URL") ?? EnvironmentUrl.Production
    );
    ...
    /// <see cref="IStiggClient.WithRawResponse"/>, don't perform validation until deserialization
    /// is triggered.</para>
    /// </summary>
    ...
    Lazy<string> _apiKey = new(() =>
        Environment.GetEnvironmentVariable("STIGG_API_KEY")
