...
public class HttpResponse : IDisposable
{
    ...
    {
        if (obj is not global::Stigg.Client.Core.HttpResponse other)
        {
            return false;
        }
    ...
    public async Task<T> Deserialize<T>(Threading::CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            return await JsonSerializer
                ...
                ?? throw new StiggInvalidDataException("Response cannot be null");
        }
...
public sealed class HttpResponse<T> : global::Stigg.Client.Core.HttpResponse
{
    ...
    internal HttpResponse(
        global::Stigg.Client.Core.HttpResponse response,
...
public sealed class StreamingHttpResponse<T> : global::Stigg.Client.Core.HttpResponse
{
