...
/// An assignment ties an entity to a capability with a usage limit and reset cadence.
///
/// <para>NOTE: Do not inherit from this type outside the SDK unless you're okay with
/// breaking changes in non-major versions. We may add new methods in the future that
/// cause existing derived classes to break.</para>
/// </summary>
public record class AssignmentListParams : ParamsBase
{
    ...
    public string? EntityID
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("entityId");
        }
        init
        {
            if (value == null)
    ...
    public AssignmentListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AssignmentListParams(AssignmentListParams assignmentListParams)
        : base(assignmentListParams)
    {
        this.ID = assignmentListParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static AssignmentListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(AssignmentListParams? other)
    {
        if (other == null)
        {
            return false;
