...
sealed class EventTypeConverter : JsonConverter<EventType>
{
    ...
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            "INCOMING_AIRBYTE_WEBHOOK" => EventType.IncomingAirbyteWebhook,
            ...
            "DATA_EXPORT_SYNC_FAILED" => EventType.DataExportSyncFailed,
    ...
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                ...
                EventType.IncomingAirbyteWebhook => "INCOMING_AIRBYTE_WEBHOOK",
                ...
                EventType.DataExportSyncFailed => "DATA_EXPORT_SYNC_FAILED",
