...
/// </summary>
public record class ContractDeleteParams : ParamsBase
{
    ...
    public ContractDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ContractDeleteParams(ContractDeleteParams contractDeleteParams)
        : base(contractDeleteParams)
    {
        this.ID = contractDeleteParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static ContractDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(ContractDeleteParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v1/contracts/{0}/archive", this.ID)
        )
        {
