...
/// Response object
/// </summary>
[JsonConverter(typeof(JsonModelConverter<ContractCreateResponse, ContractCreateResponseFromRaw>))]
public sealed record class ContractCreateResponse : JsonModel
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ContractCreateResponse(ContractCreateResponse contractCreateResponse)
        : base(contractCreateResponse) { }
#pragma warning restore CS8618

    public ContractCreateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ContractCreateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ContractCreateResponseFromRaw.FromRawUnchecked"/>
    public static ContractCreateResponse FromRawUnchecked(
    ...
    [SetsRequiredMembers]
    public ContractCreateResponse(Data data)
        : this()
    {
        this.Data = data;
    }
...
class ContractCreateResponseFromRaw : IFromRawJson<ContractCreateResponse>
{
    /// <inheritdoc/>
    public ContractCreateResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ContractCreateResponse.FromRawUnchecked(rawData);
}
...
public sealed record class Data : JsonModel
{
    ...
    /// </summary>
    public required IReadOnlyList<DataSubscription> Subscriptions
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<DataSubscription>>(
                "subscriptions"
            );
        }
        init
        {
            this._rawData.Set<ImmutableArray<DataSubscription>>(
                "subscriptions",
...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<DataSubscription, DataSubscriptionFromRaw>))]
public sealed record class DataSubscription : JsonModel
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DataSubscription(DataSubscription dataSubscription)
        : base(dataSubscription) { }
#pragma warning restore CS8618

    public DataSubscription(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    DataSubscription(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="DataSubscriptionFromRaw.FromRawUnchecked"/>
    public static DataSubscription FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class DataSubscriptionFromRaw : IFromRawJson<DataSubscription>
{
    /// <inheritdoc/>
    public DataSubscription FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        DataSubscription.FromRawUnchecked(rawData);
}
