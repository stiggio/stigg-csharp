...
/// </summary>
public record class ContractRetrieveParams : ParamsBase
{
    ...
    public ContractRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ContractRetrieveParams(ContractRetrieveParams contractRetrieveParams)
        : base(contractRetrieveParams)
    {
        this.ID = contractRetrieveParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static ContractRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(ContractRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
