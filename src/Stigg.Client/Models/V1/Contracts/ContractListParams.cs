...
/// </summary>
public record class ContractListParams : ParamsBase
{
    /// <summary>
    ...
    public string? CustomerExternalID
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("customerExternalId");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("customerExternalId", value);
        }
    }
    ...
    public ContractListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ContractListParams(ContractListParams contractListParams)
        : base(contractListParams) { }
...
#pragma warning restore CS8618
    ...
    public static ContractListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ContractListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/contracts")
        {
