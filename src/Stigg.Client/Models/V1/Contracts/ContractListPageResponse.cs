...
/// <summary>
/// A cursor-paginated list of contracts
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<ContractListPageResponse, ContractListPageResponseFromRaw>)
)]
public sealed record class ContractListPageResponse : JsonModel
{
    public required IReadOnlyList<ContractListResponse> Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<ContractListResponse>>("data");
        }
        init
        {
            this._rawData.Set<ImmutableArray<ContractListResponse>>(
                "data",
    ...
    public ContractListPageResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ContractListPageResponse(ContractListPageResponse contractListPageResponse)
        : base(contractListPageResponse) { }
#pragma warning restore CS8618

    public ContractListPageResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ContractListPageResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ContractListPageResponseFromRaw.FromRawUnchecked"/>
    public static ContractListPageResponse FromRawUnchecked(
...
class ContractListPageResponseFromRaw : IFromRawJson<ContractListPageResponse>
{
    /// <inheritdoc/>
    public ContractListPageResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ContractListPageResponse.FromRawUnchecked(rawData);
}
