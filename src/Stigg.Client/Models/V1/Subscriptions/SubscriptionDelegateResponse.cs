...
public sealed record class SubscriptionDelegateResponseData : JsonModel
{
    ...
    public IReadOnlyList<SubscriptionDelegateResponseDataPrice>? Prices
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableStruct<
                ImmutableArray<SubscriptionDelegateResponseDataPrice>
            >("prices");
        }
        init
        {
            ...
            this._rawData.Set<ImmutableArray<SubscriptionDelegateResponseDataPrice>?>(
                "prices",
...
[JsonConverter(
    typeof(JsonModelConverter<
        SubscriptionDelegateResponseDataPrice,
        SubscriptionDelegateResponseDataPriceFromRaw
    >)
)]
public sealed record class SubscriptionDelegateResponseDataPrice : JsonModel
{
    /// <summary>
    /// Price ID
    /// </summary>
    ...
    public SubscriptionDelegateResponseDataPrice() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SubscriptionDelegateResponseDataPrice(
        SubscriptionDelegateResponseDataPrice subscriptionDelegateResponseDataPrice
    )
        : base(subscriptionDelegateResponseDataPrice) { }
#pragma warning restore CS8618

    public SubscriptionDelegateResponseDataPrice(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SubscriptionDelegateResponseDataPrice(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="SubscriptionDelegateResponseDataPriceFromRaw.FromRawUnchecked"/>
    public static SubscriptionDelegateResponseDataPrice FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class SubscriptionDelegateResponseDataPriceFromRaw
    : IFromRawJson<SubscriptionDelegateResponseDataPrice>
{
    /// <inheritdoc/>
    public SubscriptionDelegateResponseDataPrice FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SubscriptionDelegateResponseDataPrice.FromRawUnchecked(rawData);
}
