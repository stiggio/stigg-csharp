...
public sealed record class Usage : JsonModel
{
    ...
    /// </summary>
    public IReadOnlyDictionary<string, UsageDimension>? Dimensions
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<FrozenDictionary<string, UsageDimension>>(
                "dimensions"
            );
        }
        init
        {
            ...
            this._rawData.Set<FrozenDictionary<string, UsageDimension>?>(
                "dimensions",
...
[JsonConverter(typeof(UsageDimensionConverter))]
public record class UsageDimension : ModelBase
{
    ...
    public UsageDimension(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public UsageDimension(double value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public UsageDimension(bool value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public UsageDimension(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new StiggInvalidDataException(
                    "Data did not match any variant of UsageDimension"
                );
        }
    }
    ...
    public static implicit operator UsageDimension(string value) => new(value);

    public static implicit operator UsageDimension(double value) => new(value);

    public static implicit operator UsageDimension(bool value) => new(value);
    ...
    public override void Validate()
    {
        if (this.Value == null)
        {
            throw new StiggInvalidDataException("Data did not match any variant of UsageDimension");
        }
    }

    public virtual bool Equals(UsageDimension? other)
    {
...
sealed class UsageDimensionConverter : JsonConverter<UsageDimension>
{
    public override UsageDimension? Read(
