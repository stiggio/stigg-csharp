...
/// </summary>
public record class AddonUpdateAddonParams : ParamsBase
{
    ...
    public AddonUpdateAddonParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AddonUpdateAddonParams(AddonUpdateAddonParams addonUpdateAddonParams)
        : base(addonUpdateAddonParams)
    {
        this.ID = addonUpdateAddonParams.ID;

        this._rawBodyData = new(addonUpdateAddonParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static AddonUpdateAddonParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(AddonUpdateAddonParams? other)
    {
        if (other == null)
        {
            return false;
