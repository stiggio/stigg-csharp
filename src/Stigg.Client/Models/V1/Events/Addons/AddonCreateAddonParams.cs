...
/// </summary>
public record class AddonCreateAddonParams : ParamsBase
{
    ...
    public AddonCreateAddonParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AddonCreateAddonParams(AddonCreateAddonParams addonCreateAddonParams)
        : base(addonCreateAddonParams)
    {
        this._rawBodyData = new(addonCreateAddonParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static AddonCreateAddonParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(AddonCreateAddonParams? other)
    {
        if (other == null)
        {
            return false;
