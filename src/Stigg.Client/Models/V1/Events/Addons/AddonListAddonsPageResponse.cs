...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<AddonListAddonsPageResponse, AddonListAddonsPageResponseFromRaw>)
)]
public sealed record class AddonListAddonsPageResponse : JsonModel
{
    public required IReadOnlyList<AddonListAddonsResponse> Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<AddonListAddonsResponse>>("data");
        }
        init
        {
            this._rawData.Set<ImmutableArray<AddonListAddonsResponse>>(
                "data",
    ...
    public AddonListAddonsPageResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AddonListAddonsPageResponse(AddonListAddonsPageResponse addonListAddonsPageResponse)
        : base(addonListAddonsPageResponse) { }
#pragma warning restore CS8618

    public AddonListAddonsPageResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    AddonListAddonsPageResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="AddonListAddonsPageResponseFromRaw.FromRawUnchecked"/>
    public static AddonListAddonsPageResponse FromRawUnchecked(
...
class AddonListAddonsPageResponseFromRaw : IFromRawJson<AddonListAddonsPageResponse>
{
    /// <inheritdoc/>
    public AddonListAddonsPageResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => AddonListAddonsPageResponse.FromRawUnchecked(rawData);
}
