...
/// </summary>
public record class AddonListAddonsParams : ParamsBase
{
    /// <summary>
    ...
    public AddonListAddonsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AddonListAddonsParams(AddonListAddonsParams addonListAddonsParams)
        : base(addonListAddonsParams) { }
...
#pragma warning restore CS8618
    ...
    public static AddonListAddonsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(AddonListAddonsParams? other)
    {
        if (other == null)
        {
            return false;
