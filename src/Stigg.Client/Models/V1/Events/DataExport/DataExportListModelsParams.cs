...
/// </summary>
public record class DataExportListModelsParams : ParamsBase
{
    ...
    public DataExportListModelsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DataExportListModelsParams(DataExportListModelsParams dataExportListModelsParams)
        : base(dataExportListModelsParams) { }
...
#pragma warning restore CS8618
    ...
    public static DataExportListModelsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(DataExportListModelsParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/data-export/models"
        )
        {
