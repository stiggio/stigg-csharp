...
public record class EntityTypeUpsertParams : ParamsBase
{
    ...
    /// </summary>
    public required IReadOnlyList<global::Stigg.Client.Models.V1.Events.Beta.EntityTypes.Type> Types
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullStruct<
                ImmutableArray<global::Stigg.Client.Models.V1.Events.Beta.EntityTypes.Type>
            >("types");
        }
        init
        {
...
[JsonConverter(
    typeof(JsonModelConverter<
        global::Stigg.Client.Models.V1.Events.Beta.EntityTypes.Type,
        TypeFromRaw
    >)
)]
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public Type(global::Stigg.Client.Models.V1.Events.Beta.EntityTypes.Type type)
        : base(type) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    public static global::Stigg.Client.Models.V1.Events.Beta.EntityTypes.Type FromRawUnchecked(
...
class TypeFromRaw : IFromRawJson<global::Stigg.Client.Models.V1.Events.Beta.EntityTypes.Type>
{
    /// <inheritdoc/>
    public global::Stigg.Client.Models.V1.Events.Beta.EntityTypes.Type FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => global::Stigg.Client.Models.V1.Events.Beta.EntityTypes.Type.FromRawUnchecked(rawData);
}
