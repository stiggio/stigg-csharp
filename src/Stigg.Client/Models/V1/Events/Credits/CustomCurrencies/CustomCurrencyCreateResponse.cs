...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<CustomCurrencyCreateResponse, CustomCurrencyCreateResponseFromRaw>)
)]
public sealed record class CustomCurrencyCreateResponse : JsonModel
{
    /// <summary>
    ...
    public CustomCurrencyCreateResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CustomCurrencyCreateResponse(CustomCurrencyCreateResponse customCurrencyCreateResponse)
        : base(customCurrencyCreateResponse) { }
#pragma warning restore CS8618

    public CustomCurrencyCreateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CustomCurrencyCreateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="CustomCurrencyCreateResponseFromRaw.FromRawUnchecked"/>
    public static CustomCurrencyCreateResponse FromRawUnchecked(
    ...
    [SetsRequiredMembers]
    public CustomCurrencyCreateResponse(Data data)
        : this()
    {
        this.Data = data;
    }
...
class CustomCurrencyCreateResponseFromRaw : IFromRawJson<CustomCurrencyCreateResponse>
{
    /// <inheritdoc/>
    public CustomCurrencyCreateResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => CustomCurrencyCreateResponse.FromRawUnchecked(rawData);
}
