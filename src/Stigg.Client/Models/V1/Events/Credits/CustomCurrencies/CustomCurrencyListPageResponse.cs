...
[JsonConverter(
    typeof(JsonModelConverter<
        CustomCurrencyListPageResponse,
        CustomCurrencyListPageResponseFromRaw
    >)
)]
public sealed record class CustomCurrencyListPageResponse : JsonModel
{
    public required IReadOnlyList<CustomCurrencyListResponse> Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<CustomCurrencyListResponse>>(
                "data"
            );
        }
        init
        {
            this._rawData.Set<ImmutableArray<CustomCurrencyListResponse>>(
                "data",
    ...
    public CustomCurrencyListPageResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CustomCurrencyListPageResponse(
        CustomCurrencyListPageResponse customCurrencyListPageResponse
    )
        : base(customCurrencyListPageResponse) { }
#pragma warning restore CS8618

    public CustomCurrencyListPageResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CustomCurrencyListPageResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="CustomCurrencyListPageResponseFromRaw.FromRawUnchecked"/>
    public static CustomCurrencyListPageResponse FromRawUnchecked(
...
class CustomCurrencyListPageResponseFromRaw : IFromRawJson<CustomCurrencyListPageResponse>
{
    /// <inheritdoc/>
    public CustomCurrencyListPageResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => CustomCurrencyListPageResponse.FromRawUnchecked(rawData);
}
