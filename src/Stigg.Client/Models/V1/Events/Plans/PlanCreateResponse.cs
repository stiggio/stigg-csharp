...
/// Response object
/// </summary>
[JsonConverter(typeof(JsonModelConverter<PlanCreateResponse, PlanCreateResponseFromRaw>))]
public sealed record class PlanCreateResponse : JsonModel
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PlanCreateResponse(PlanCreateResponse planCreateResponse)
        : base(planCreateResponse) { }
#pragma warning restore CS8618

    public PlanCreateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    PlanCreateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="PlanCreateResponseFromRaw.FromRawUnchecked"/>
    public static PlanCreateResponse FromRawUnchecked(
    ...
    [SetsRequiredMembers]
    public PlanCreateResponse(Data data)
        : this()
    {
        this.Data = data;
    }
...
class PlanCreateResponseFromRaw : IFromRawJson<PlanCreateResponse>
{
    /// <inheritdoc/>
    public PlanCreateResponse FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        PlanCreateResponse.FromRawUnchecked(rawData);
}
...
public sealed record class Entitlement : JsonModel
{
    ...
    public required ApiEnum<string, global::Stigg.Client.Models.V1.Events.Plans.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::Stigg.Client.Models.V1.Events.Plans.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::Stigg.Client.Models.V1.Events.Plans.Type>
{
    public override global::Stigg.Client.Models.V1.Events.Plans.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "FEATURE" => global::Stigg.Client.Models.V1.Events.Plans.Type.Feature,
            "CREDIT" => global::Stigg.Client.Models.V1.Events.Plans.Type.Credit,
            _ => (global::Stigg.Client.Models.V1.Events.Plans.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Stigg.Client.Models.V1.Events.Plans.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Stigg.Client.Models.V1.Events.Plans.Type.Feature => "FEATURE",
                global::Stigg.Client.Models.V1.Events.Plans.Type.Credit => "CREDIT",
                _ => throw new StiggInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
