...
namespace Stigg.Client.Models.V1.Credits.AutoRecharge;
...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        AutoRechargeGetAutoRechargeResponseFromRaw
    >)
)]
public sealed record class AutoRechargeGetAutoRechargeResponse : JsonModel
{
    /// <summary>
    ...
    public AutoRechargeGetAutoRechargeResponse() { }
...
#pragma warning disable CS8618
    ...
    public AutoRechargeGetAutoRechargeResponse(
        ...
        : base(autoRechargeGetAutoRechargeResponse) { }
#pragma warning restore CS8618

    public AutoRechargeGetAutoRechargeResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    AutoRechargeGetAutoRechargeResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="AutoRechargeGetAutoRechargeResponseFromRaw.FromRawUnchecked"/>
    public static AutoRechargeGetAutoRechargeResponse FromRawUnchecked(
    ...
    [SetsRequiredMembers]
    public AutoRechargeGetAutoRechargeResponse(Data data)
        : this()
    {
        this.Data = data;
    }
...
class AutoRechargeGetAutoRechargeResponseFromRaw : IFromRawJson<AutoRechargeGetAutoRechargeResponse>
{
    /// <inheritdoc/>
    public AutoRechargeGetAutoRechargeResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => AutoRechargeGetAutoRechargeResponse.FromRawUnchecked(rawData);
}
