...
/// </summary>
public record class GrantVoidParams : ParamsBase
{
    ...
    public GrantVoidParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public GrantVoidParams(GrantVoidParams grantVoidParams)
        : base(grantVoidParams)
    {
        this.ID = grantVoidParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static GrantVoidParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(GrantVoidParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v1/credits/grants/{0}/void", this.ID)
        )
        {
