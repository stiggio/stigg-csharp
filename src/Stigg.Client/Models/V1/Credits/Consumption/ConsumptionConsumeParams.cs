...
/// <summary>
/// Consumes a specified amount of credits directly from a customer wallet, with
/// no feature mapping. Returns the optimistic balance.
///
/// <para>NOTE: Do not inherit from this type outside the SDK unless you're okay with
/// breaking changes in non-major versions. We may add new methods in the future that
/// cause existing derived classes to break.</para>
/// </summary>
public record class ConsumptionConsumeParams : ParamsBase
{
    ...
    public required string IdempotencyKey
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<string>("idempotencyKey");
        }
        init { this._rawBodyData.Set("idempotencyKey", value); }
    }
    ...
    public DateTimeOffset? CreatedAt
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableStruct<DateTimeOffset>("createdAt");
        }
        init
        {
            if (value == null)
            ...
            this._rawBodyData.Set("createdAt", value);
        }
    }
    ...
    public ConsumptionConsumeParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ConsumptionConsumeParams(ConsumptionConsumeParams consumptionConsumeParams)
        : base(consumptionConsumeParams)
    {
        this._rawBodyData = new(consumptionConsumeParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ConsumptionConsumeParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(ConsumptionConsumeParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/credits/consumption"
        )
        {
