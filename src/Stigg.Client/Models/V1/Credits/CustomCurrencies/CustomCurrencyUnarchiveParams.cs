...
/// </summary>
public record class CustomCurrencyUnarchiveParams : ParamsBase
{
    ...
    public CustomCurrencyUnarchiveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CustomCurrencyUnarchiveParams(
        CustomCurrencyUnarchiveParams customCurrencyUnarchiveParams
    )
        : base(customCurrencyUnarchiveParams)
    {
        this.CurrencyID = customCurrencyUnarchiveParams.CurrencyID;
    }
...
#pragma warning restore CS8618
    ...
    public static CustomCurrencyUnarchiveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string currencyID
    )
    ...
    public virtual bool Equals(CustomCurrencyUnarchiveParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v1/credits/custom-currencies/{0}/unarchive", this.CurrencyID)
        )
        {
