...
/// Response object
/// </summary>
[JsonConverter(typeof(JsonModelConverter<CustomCurrencyResponse, CustomCurrencyResponseFromRaw>))]
public sealed record class CustomCurrencyResponse : JsonModel
{
    /// <summary>
    ...
    public CustomCurrencyResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CustomCurrencyResponse(CustomCurrencyResponse customCurrencyResponse)
        : base(customCurrencyResponse) { }
#pragma warning restore CS8618

    public CustomCurrencyResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CustomCurrencyResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="CustomCurrencyResponseFromRaw.FromRawUnchecked"/>
    public static CustomCurrencyResponse FromRawUnchecked(
    ...
    [SetsRequiredMembers]
    public CustomCurrencyResponse(Data data)
        : this()
    {
        this.Data = data;
    }
...
class CustomCurrencyResponseFromRaw : IFromRawJson<CustomCurrencyResponse>
{
    /// <inheritdoc/>
    public CustomCurrencyResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => CustomCurrencyResponse.FromRawUnchecked(rawData);
}
