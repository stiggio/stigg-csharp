...
/// </summary>
public record class CustomerRetrieveEntitlementsParams : ParamsBase
{
    ...
    public CustomerRetrieveEntitlementsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CustomerRetrieveEntitlementsParams(
        CustomerRetrieveEntitlementsParams customerRetrieveEntitlementsParams
    )
        : base(customerRetrieveEntitlementsParams)
    {
        this.ID = customerRetrieveEntitlementsParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static CustomerRetrieveEntitlementsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(CustomerRetrieveEntitlementsParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v1/customers/{0}/entitlements", this.ID)
        )
        {
