...
/// </summary>
public record class CustomerListContractsParams : ParamsBase
{
    ...
    public CustomerListContractsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CustomerListContractsParams(CustomerListContractsParams customerListContractsParams)
        : base(customerListContractsParams)
    {
        this.ID = customerListContractsParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static CustomerListContractsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(CustomerListContractsParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v1/customers/{0}/contracts", this.ID)
        )
        {
