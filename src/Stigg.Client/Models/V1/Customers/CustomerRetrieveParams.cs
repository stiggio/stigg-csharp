...
/// </summary>
public record class CustomerRetrieveParams : ParamsBase
{
...
#pragma warning disable CS8618
    ...
    {
        this.ID = customerRetrieveParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static CustomerRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(CustomerRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
