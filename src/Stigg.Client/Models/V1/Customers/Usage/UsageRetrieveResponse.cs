...
public sealed record class Marker : JsonModel
{
    ...
    /// </summary>
    public required ApiEnum<string, global::Stigg.Client.Models.V1.Customers.Usage.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::Stigg.Client.Models.V1.Customers.Usage.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::Stigg.Client.Models.V1.Customers.Usage.Type>
{
    public override global::Stigg.Client.Models.V1.Customers.Usage.Type Read(
    ...
    )
    {
        ...
        {
            "PERIODIC_RESET" => global::Stigg.Client.Models.V1.Customers.Usage.Type.PeriodicReset,
            "SUBSCRIPTION_CHANGE_RESET" => global::Stigg
                ...
                .Type
                .SubscriptionChangeReset,
            _ => (global::Stigg.Client.Models.V1.Customers.Usage.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Stigg.Client.Models.V1.Customers.Usage.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Stigg.Client.Models.V1.Customers.Usage.Type.PeriodicReset =>
                    "PERIODIC_RESET",
                global::Stigg.Client.Models.V1.Customers.Usage.Type.SubscriptionChangeReset =>
