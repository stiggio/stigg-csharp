...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<IntegrationListPageResponse, IntegrationListPageResponseFromRaw>)
)]
public sealed record class IntegrationListPageResponse : JsonModel
{
    public required IReadOnlyList<IntegrationListResponse> Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<IntegrationListResponse>>("data");
        }
        init
        {
            this._rawData.Set<ImmutableArray<IntegrationListResponse>>(
                "data",
    ...
    public IntegrationListPageResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IntegrationListPageResponse(IntegrationListPageResponse integrationListPageResponse)
        : base(integrationListPageResponse) { }
#pragma warning restore CS8618

    public IntegrationListPageResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    IntegrationListPageResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="IntegrationListPageResponseFromRaw.FromRawUnchecked"/>
    public static IntegrationListPageResponse FromRawUnchecked(
...
class IntegrationListPageResponseFromRaw : IFromRawJson<IntegrationListPageResponse>
{
    /// <inheritdoc/>
    public IntegrationListPageResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => IntegrationListPageResponse.FromRawUnchecked(rawData);
}
