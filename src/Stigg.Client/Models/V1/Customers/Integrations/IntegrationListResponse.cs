...
sealed class IntegrationListResponseVendorIdentifierConverter
    : JsonConverter<IntegrationListResponseVendorIdentifier>
{
    public override IntegrationListResponseVendorIdentifier Read(
    ...
    public override void Write(
        ...
        IntegrationListResponseVendorIdentifier value,
        JsonSerializerOptions options
    )
    {
