...
/// </summary>
public record class IntegrationRetrieveParams : ParamsBase
{
    ...
    public IntegrationRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IntegrationRetrieveParams(IntegrationRetrieveParams integrationRetrieveParams)
        : base(integrationRetrieveParams)
    {
        this.ID = integrationRetrieveParams.ID;
        this.IntegrationID = integrationRetrieveParams.IntegrationID;
    }
...
#pragma warning restore CS8618
    ...
    public static IntegrationRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id,
        string integrationID
    ...
    public virtual bool Equals(IntegrationRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
