...
/// </summary>
public record class PlanRetrieveParams : ParamsBase
{
    ...
    public PlanRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PlanRetrieveParams(PlanRetrieveParams planRetrieveParams)
        : base(planRetrieveParams)
    {
        this.ID = planRetrieveParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static PlanRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(PlanRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
