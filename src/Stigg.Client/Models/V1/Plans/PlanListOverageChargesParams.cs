...
/// </summary>
public record class PlanListOverageChargesParams : ParamsBase
{
    ...
    public PlanListOverageChargesParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PlanListOverageChargesParams(PlanListOverageChargesParams planListOverageChargesParams)
        : base(planListOverageChargesParams)
    {
        this.ID = planListOverageChargesParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static PlanListOverageChargesParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(PlanListOverageChargesParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v1/plans/{0}/overage-charges", this.ID)
        )
        {
