...
/// <summary>
/// Sets the pricing configuration for a plan, including pricing models, overage pricing,
/// and minimum spend.
///
...
/// </summary>
public record class PlanSetPricingParams : ParamsBase
{
    ...
    /// </summary>
    public required ApiEnum<string, PlanSetPricingParamsPricingType> PricingType
    {
        get
        {
    ...
    public IReadOnlyList<MinimumSpend>? MinimumSpend
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableStruct<ImmutableArray<MinimumSpend>>(
                "minimumSpend"
            );
        }
        init
        {
            this._rawBodyData.Set<ImmutableArray<MinimumSpend>?>(
                "minimumSpend",
    ...
    public ApiEnum<string, OverageBillingPeriod>? OverageBillingPeriod
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<ApiEnum<string, OverageBillingPeriod>>(
        ...
        init
        {
            ...
            this._rawBodyData.Set("overageBillingPeriod", value);
        }
    }
    ...
    public IReadOnlyList<OveragePricingModel>? OveragePricingModels
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableStruct<ImmutableArray<OveragePricingModel>>(
        ...
        init
        {
            ...
            this._rawBodyData.Set<ImmutableArray<OveragePricingModel>?>(
                "overagePricingModels",
                value == null ? null : ImmutableArray.ToImmutableArray(value)
            );
        }
    ...
    public IReadOnlyList<PricingModel>? PricingModels
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableStruct<ImmutableArray<PricingModel>>(
                "pricingModels"
            );
        }
        init
        {
            ...
            this._rawBodyData.Set<ImmutableArray<PricingModel>?>(
                "pricingModels",
                value == null ? null : ImmutableArray.ToImmutableArray(value)
            );
        }
    ...
    public PlanSetPricingParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PlanSetPricingParams(PlanSetPricingParams planSetPricingParams)
        : base(planSetPricingParams)
    {
        this.ID = planSetPricingParams.ID;

        this._rawBodyData = new(planSetPricingParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PlanSetPricingParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(PlanSetPricingParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override System::Uri Url(ClientOptions options)
    {
        return new System::UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v1/plans/{0}/charges", this.ID)
        )
        {
...
/// The pricing type (FREE, PAID, or CUSTOM)
/// </summary>
[JsonConverter(typeof(PlanSetPricingParamsPricingTypeConverter))]
public enum PlanSetPricingParamsPricingType
{
    Free,
    Paid,
    Custom,
...
sealed class PlanSetPricingParamsPricingTypeConverter
    : JsonConverter<PlanSetPricingParamsPricingType>
{
    public override PlanSetPricingParamsPricingType Read(
    ...
    )
    {
        ...
        {
            "FREE" => PlanSetPricingParamsPricingType.Free,
            "PAID" => PlanSetPricingParamsPricingType.Paid,
            "CUSTOM" => PlanSetPricingParamsPricingType.Custom,
            _ => (PlanSetPricingParamsPricingType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        PlanSetPricingParamsPricingType value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                PlanSetPricingParamsPricingType.Free => "FREE",
                PlanSetPricingParamsPricingType.Paid => "PAID",
                PlanSetPricingParamsPricingType.Custom => "CUSTOM",
