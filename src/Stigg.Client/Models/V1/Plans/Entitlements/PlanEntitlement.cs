...
public sealed record class Data : JsonModel
{
    ...
    /// </summary>
    public required ApiEnum<string, global::Stigg.Client.Models.V1.Plans.Entitlements.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::Stigg.Client.Models.V1.Plans.Entitlements.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::Stigg.Client.Models.V1.Plans.Entitlements.Type>
{
    public override global::Stigg.Client.Models.V1.Plans.Entitlements.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "FEATURE" => global::Stigg.Client.Models.V1.Plans.Entitlements.Type.Feature,
            "CREDIT" => global::Stigg.Client.Models.V1.Plans.Entitlements.Type.Credit,
            _ => (global::Stigg.Client.Models.V1.Plans.Entitlements.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Stigg.Client.Models.V1.Plans.Entitlements.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Stigg.Client.Models.V1.Plans.Entitlements.Type.Feature => "FEATURE",
                global::Stigg.Client.Models.V1.Plans.Entitlements.Type.Credit => "CREDIT",
                _ => throw new StiggInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
