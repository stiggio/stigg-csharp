...
/// </summary>
public record class ProductListProductsParams : ParamsBase
{
    /// <summary>
    /// Filter by entity ID
    /// </summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ProductListProductsParams(ProductListProductsParams productListProductsParams)
        : base(productListProductsParams) { }
...
#pragma warning restore CS8618
    ...
    public static ProductListProductsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ProductListProductsParams? other)
    {
        if (other == null)
        {
            return false;
