...
/// </summary>
public record class ProductCreateProductParams : ParamsBase
{
    ...
    public ProductCreateProductParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ProductCreateProductParams(ProductCreateProductParams productCreateProductParams)
        : base(productCreateProductParams)
    {
        this._rawBodyData = new(productCreateProductParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(ProductCreateProductParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/products")
        {
