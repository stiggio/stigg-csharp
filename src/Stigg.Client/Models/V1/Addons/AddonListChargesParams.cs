...
/// </summary>
public record class AddonListChargesParams : ParamsBase
{
    ...
    public AddonListChargesParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AddonListChargesParams(AddonListChargesParams addonListChargesParams)
        : base(addonListChargesParams)
    {
        this.ID = addonListChargesParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static AddonListChargesParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string id
    )
    ...
    public virtual bool Equals(AddonListChargesParams? other)
    {
        if (other == null)
        {
            return false;
