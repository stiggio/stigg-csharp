...
/// </summary>
public record class AddonSetPricingParams : ParamsBase
{
    ...
    /// </summary>
    public required ApiEnum<string, AddonSetPricingParamsPricingType> PricingType
    {
        get
        {
    ...
    public AddonSetPricingParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AddonSetPricingParams(AddonSetPricingParams addonSetPricingParams)
        : base(addonSetPricingParams)
    {
        this.ID = addonSetPricingParams.ID;

        this._rawBodyData = new(addonSetPricingParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static AddonSetPricingParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(AddonSetPricingParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override System::Uri Url(ClientOptions options)
    {
        return new System::UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v1/addons/{0}/charges", this.ID)
        )
        {
...
/// The pricing type (FREE, PAID, or CUSTOM)
/// </summary>
[JsonConverter(typeof(AddonSetPricingParamsPricingTypeConverter))]
public enum AddonSetPricingParamsPricingType
{
    Free,
    Paid,
    Custom,
...
sealed class AddonSetPricingParamsPricingTypeConverter
    : JsonConverter<AddonSetPricingParamsPricingType>
{
    public override AddonSetPricingParamsPricingType Read(
    ...
    )
    {
        ...
        {
            "FREE" => AddonSetPricingParamsPricingType.Free,
            "PAID" => AddonSetPricingParamsPricingType.Paid,
            "CUSTOM" => AddonSetPricingParamsPricingType.Custom,
            _ => (AddonSetPricingParamsPricingType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        AddonSetPricingParamsPricingType value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                AddonSetPricingParamsPricingType.Free => "FREE",
                AddonSetPricingParamsPricingType.Paid => "PAID",
                AddonSetPricingParamsPricingType.Custom => "CUSTOM",
