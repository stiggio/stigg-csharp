...
public sealed record class DataEntitlement : JsonModel
{
    ...
    public required ApiEnum<string, global::Stigg.Client.Models.V1.Addons.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::Stigg.Client.Models.V1.Addons.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::Stigg.Client.Models.V1.Addons.Type>
{
    public override global::Stigg.Client.Models.V1.Addons.Type Read(
    ...
    )
    {
        ...
        {
            "FEATURE" => global::Stigg.Client.Models.V1.Addons.Type.Feature,
            "CREDIT" => global::Stigg.Client.Models.V1.Addons.Type.Credit,
            _ => (global::Stigg.Client.Models.V1.Addons.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Stigg.Client.Models.V1.Addons.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Stigg.Client.Models.V1.Addons.Type.Feature => "FEATURE",
                global::Stigg.Client.Models.V1.Addons.Type.Credit => "CREDIT",
