...
public class HttpResponse : IDisposable
{
    ...
    {
        if (obj is not global::Stigg.Core.HttpResponse other)
        {
            return false;
        }
...
public sealed class HttpResponse<T> : global::Stigg.Core.HttpResponse
{
    ...
    internal HttpResponse(
        global::Stigg.Core.HttpResponse response,
...
public sealed class StreamingHttpResponse<T> : global::Stigg.Core.HttpResponse
{
