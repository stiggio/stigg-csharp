...
{
    public required IReadOnlyList<CustomerListResponse> Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<CustomerListResponse>>("data");
        }
        init
        {
            this._rawData.Set<ImmutableArray<CustomerListResponse>>(
                "data",
