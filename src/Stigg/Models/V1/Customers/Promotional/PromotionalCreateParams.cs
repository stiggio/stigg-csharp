...
/// </summary>
public record class PromotionalCreateParams : ParamsBase
{
    ...
    public PromotionalCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PromotionalCreateParams(PromotionalCreateParams promotionalCreateParams)
        : base(promotionalCreateParams)
    {
        this.CustomerID = promotionalCreateParams.CustomerID;

        this._rawBodyData = new(promotionalCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PromotionalCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(PromotionalCreateParams? other)
    {
        if (other == null)
        {
            return false;
