...
[JsonConverter(typeof(JsonModelConverter<CouponCreateResponse, CouponCreateResponseFromRaw>))]
public sealed record class CouponCreateResponse : JsonModel
{
    ...
    public CouponCreateResponse(CouponCreateResponse couponCreateResponse)
        : base(couponCreateResponse) { }

    public CouponCreateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CouponCreateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="CouponCreateResponseFromRaw.FromRawUnchecked"/>
    public static CouponCreateResponse FromRawUnchecked(
    ...
    [SetsRequiredMembers]
    public CouponCreateResponse(Data data)
        : this()
    {
        this.Data = data;
    }
...
class CouponCreateResponseFromRaw : IFromRawJson<CouponCreateResponse>
{
    /// <inheritdoc/>
    public CouponCreateResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => CouponCreateResponse.FromRawUnchecked(rawData);
}
...
public sealed record class Data : JsonModel
{
    ...
    /// </summary>
    public required ApiEnum<string, global::Stigg.Models.V1.Coupons.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::Stigg.Models.V1.Coupons.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::Stigg.Models.V1.Coupons.Type>
{
    public override global::Stigg.Models.V1.Coupons.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "FIXED" => global::Stigg.Models.V1.Coupons.Type.Fixed,
            "PERCENTAGE" => global::Stigg.Models.V1.Coupons.Type.Percentage,
            _ => (global::Stigg.Models.V1.Coupons.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Stigg.Models.V1.Coupons.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Stigg.Models.V1.Coupons.Type.Fixed => "FIXED",
                global::Stigg.Models.V1.Coupons.Type.Percentage => "PERCENTAGE",
                _ => throw new StiggInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
